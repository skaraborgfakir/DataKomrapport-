%%
%% Time-stamp: <2019-05-01 17:59:18 stefan>
%%
...
\usepackage{color}
\usepackage[table]{xcolor} %% \definecolor, den gråa bakgrunden i kodlistningarna
...
\begin{figure}
  \centering
  \caption{Nätverkets organisation}
...
att förbindelsen ska ses som ett flöde utan några för applikationen direkt synliga gränser.

TCP är tillförlig i betydelsen att avsändare och mottagare ska få rapport det blir
ett avbrott i förbindelsen som medför att det hos mottagaren saknas data som skulle ha varit med.
Data som leveraras till mottagande program får inte vara förvanskat och alla data ska överlämnas
...
underliggande moduler exv IP och ARP.)

DECnet är ett exempel där användaren installerar ett separat program för att implementera
TCP ovanför en otillförlitlig transport via DECnet (eller X25.)
